...
<center>
  <img src="images/welcometolog.gif" alt="welcome image" style="width: 350px">
</center>

<div class="container mt-3 mb-5" style="max-width: 600px;"> <!-- Adjusted max-width -->
  <?php
    if (isset($_SESSION['status1'])) {
  ?>
    <div class="alert alert-success alert-dismissible">
      <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
      <weak>Slay!</weak> <?= $_SESSION['status1'] ?>
    </div>
  <?php
  ...
  ?>
    <div class="alert alert-danger alert-dismissible">
      <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
      <strong>Ow Naur!</strong> <?= $_SESSION['status2'] ?>
    </div>
  <?php 
  ...
  ?>
  <div class="card">
    <div class="card-header bg-grey"><b>REGISTRATION FORM</b></div>
    <div class="card-body">
